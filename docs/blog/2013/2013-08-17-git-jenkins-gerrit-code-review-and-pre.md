...
So, what does it mean *"pre-tested commit"*? Initially this type of commits was introduced in [TeamCity](http://www.jetbrains.com/teamcity/) CI Server:  
...
![Standard scenario diagram](2013-08-17-git-jenkins-gerrit-code-review-and-pre/Standard-scenario.gif)
![TeamCity scenario diagram](2013-08-17-git-jenkins-gerrit-code-review-and-pre/TeamCity-scenario.gif)
...
![Git Gerrit Jenkins workflow](2013-08-17-git-jenkins-gerrit-code-review-and-pre/Git_gerrit_jenkins.png)
